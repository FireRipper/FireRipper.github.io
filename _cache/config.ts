...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Illia',
      'profile:gender': 'male', // male, female
      'profile:last_name': 'Shabelnyk',
    },
  ...
  data: {
     ...
     */
    socialMedia: [
      { name: 'Github', icon: 'github', link: 'https://github.com/FireRipper' },
      { name: 'LinkedIn', icon: 'linkedin', link: 'https://linkedin.com/in/illia-shabelnyk' },
    ],
  },
